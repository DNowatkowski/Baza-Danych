            ...
            public string UserName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Wartość z kolumny \'UserName\' w tabeli \'Table\' to DBNull.", e);
                    }
                }
                set {
...
namespace BazaDanych2.UserDataBaseDataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([UserName]) VALUES (@UserName);\r\nSELECT Id, UserName F" +
                "ROM [Table] WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [UserName] = @UserName WHERE (([Id] = @Original_Id) AND " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BazaDanych2.Properties.Settings.Default.UserDataBaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UserName FROM dbo.[Table]";
        ...
        public virtual int Fill(UserDataBaseDataSet1.TableDataTable dataTable) {
        ...
        public virtual UserDataBaseDataSet1.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UserDataBaseDataSet1.TableDataTable dataTable = new UserDataBaseDataSet1.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UserDataBaseDataSet1.TableDataTable dataTable) {
